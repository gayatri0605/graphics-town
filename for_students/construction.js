...
export class ForkLift extends GrObject {
    ...
    constructor(params={}) {
      ...
      bevelSegments: 2
        ...
        let rb_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let engine_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let ex_mat = new T.MeshStandardMaterial({color:"brown"});
        ...
        let wh_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let pivot_mat = new T.MeshStandardMaterial({color:"brown"});
        ...
        let fb_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let cab_mat = new T.MeshStandardMaterial({color:"brown"});
        ...
        let fp_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let vs_mat = new T.MeshStandardMaterial({color:"brown"});
        ...
        let bp_mat = new T.MeshStandardMaterial({color:"blue"});
        ...
        let fork_mat = new T.MeshStandardMaterial({color:"brown"});
        ...
        // put the object in its place
        this.whole_ob.position.x = params.x ? Number(params.x) : 23;
        this.whole_ob.position.y = params.y ? Number(params.y) : 0;
        this.whole_ob.position.z = params.z ? Number(params.z) : 15;
        let scale = params.size ? Number(params.size) : 1;
...
export class GantryCrane extends GrObject {
    ...
    constructor(params={}) {
        ...
        let supp_post_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let xr_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let xrt_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let zr_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let cb_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let cbt_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let clawBase_mat = new T.MeshStandardMaterial({color:"grey"});
        ...
        let claw_mat = new T.MeshStandardMaterial({color:"grey"});
        let claw;
